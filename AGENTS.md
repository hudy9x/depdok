...
- **LLM v2 Subsystem (Rig + Ollama + Frontend Tool-Calling)**: Implements decoupled orchestrator in Rust (`src-tauri/src/llm2/`) with tool execution running directly in React/TypeScript (`src/features/LLMChat2/`), supporting parallel multi-tool calling, Jotai store integration, and live tool monitors. Architecture reference is at [docs/new-llm.md](file:///Users/hudy/ws/depdok/docs/new-llm.md) and step-by-step tool creation guide for AI agents is at [docs/llm2-tool-creation-guide.md](file:///Users/hudy/ws/depdok/docs/llm2-tool-creation-guide.md).
