...
- **LLM v1 Subsystem**: Implements local GGUF models (`llama.cpp`), remote API clients, global state coordination, recursive agentic tool calls, and UI chat panel. Complete architecture and guide is at [docs/llm-integration.md](file:///Users/hudy/ws/depdok/docs/llm-integration.md).
- **LLM v2 Subsystem (Rig + Ollama + Frontend Tool-Calling & Dual-Model)**: Implements decoupled orchestrator in Rust (`src-tauri/src/llm2/`) with tool execution running directly in React/TypeScript (`src/features/LLMChat2/`), supporting real-time streaming, `@` file mentions, inline tool inspector cards, and dual-model specialization (`qwen2.5:7b` + `gemma2:9b`). Complete architecture and system manual is at [docs/llm/LLM2_SYSTEM_OVERVIEW.md](file:///Users/hudy/ws/depdok/docs/llm/LLM2_SYSTEM_OVERVIEW.md), dual-model reference at [docs/llm/DUAL_MODEL_ARCHITECTURE.md](file:///Users/hudy/ws/depdok/docs/llm/DUAL_MODEL_ARCHITECTURE.md), and step-by-step tool creation guide at [docs/llm/llm2-tool-creation-guide.md](file:///Users/hudy/ws/depdok/docs/llm/llm2-tool-creation-guide.md).
